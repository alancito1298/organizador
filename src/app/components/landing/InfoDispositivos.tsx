  ...
  return (
    <section className="py-xl px-margin-mobile md:px-margin-desktop bg-surface-lavender border-y border-outline-variant/20 text-center" id="dispositivos">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant mb-xl">Llevá tu agenda y planillas a todas partes. Tu información se sincroniza automáticamente en la nube.</p>
